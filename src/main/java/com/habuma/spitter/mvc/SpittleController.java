...
public class SpittleController {
	...
	public String createSpittleFromForm(@Valid Spittle spittle, BindingResult result, HttpServletResponse response)
...
//	public String updateSpittle(@PathVariable("id") long id, @Valid Spittle spittle) {
//		spitterService.saveSpittle(spittle);
