		...
		<fieldset>
			<table cellspacing="0">
				<tr>
					...
					<td><sf:input path="fullName" size="15" /><br /> <sf:errors
				...
				<tr>
					...
					<td><sf:input path="email" size="30" /> <small>In case
							you forget something</small><br /> <sf:errors path="email"
							cssClass="error" /></td>
				</tr>
				<tr>
				...
				<tr>
					<th></th>
					<td><sf:checkbox path="updateByEmail" /> <sf:label
							path="updateByEmail">Send me email updates!</sf:label>
