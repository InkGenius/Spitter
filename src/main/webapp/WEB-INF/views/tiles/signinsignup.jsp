...
<div>
  <sec:authorize access="!isAuthenticated()">
	...
	<form class="signin"
		action="<s:url value="/static/j_spring_security_check"/>"
		method="post">
		<fieldset>
			<div>
				<label for="j_username">Username or Email</label> <input id="email"
			...
			<input id="remember_me" type="checkbox" value="1"
				...
				me</label> <small> <a href="/account/resend_password">Forgot?</a>
			</small> <input id="submit" type="submit" value="Sign In!" name="commit" />
		</fieldset>
	</form>
	<div class="notify">
		Want an account? <br /> <a class="join"
			href="<s:url value="/spitters?new"/>">Join for Free!</a> <br /> It's
		fast and easy!
	</div>
    </sec:authorize>
